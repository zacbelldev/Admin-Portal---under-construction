...
<main id="mainContainer">
    ...
    <div class="mainContainerChildbanner">
        <h3>Data > Misc > Department Log</h3>
        <a href='/'><img id='settingsIcon' src='/images/settingsIcon.png'></a>
    ...
    <div class="wrapper">
        <div class="header">
            <a href="/view/tools/index.php?action=________" class="export">Export Template File</a>
            <span class="import" onclick="show_popup('popup_upload')">Import Log File</span>
            <a href="/view/tools/index.php?action=displayLogForm" class="export">Create Log Entry</a>
            <h1 class="previousPage">Log Files</h1><br>
        </div>
        <?php


        //        next step: fix the code below to properly display the log entry data!!!

        if (isset($message)) {
            echo "<br>" . $message . "<br>";
        }

        if (isset($logDataTable)) {
            echo $logDataTable;
        }
        ?>
    ...
    <div id="popup_upload">
        <div class="form_upload">
            ...
            <form action="/view/tools/index.php?action=__________" method="post" enctype="multipart/form-data">
