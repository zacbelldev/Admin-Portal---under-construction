    ...
    <div class="mainContainerChildHexContainer">
        <div class="mainContainerChildHexChild">
            <div class="hex-row hex-row-even">
                <a href="/view/data/index.php?action=operations">
                    <div class="hex">
                        <p class="overlayText">Operations</p>
                    </div>
                </a>
                <a href="/view/data/index.php?action=accounting">
                    <div class="hex">
            ...
            <div class="hex-row">
                <a href="/view/data/index.php?action=sales">
                    <div class="hex">
                        <p class="overlayText">Sales</p>
                    </div>
                </a>
                <a href="/view/data/index.php?action=marketing">
                    <div class="hex">
                        <p class="overlayText">Marketing</p>
                    </div>
                </a>
                <a href="/view/data/index.php?action=productivity">
                    <div class="hex">
            ...
            <div class="hex-row hex-row-even">
                <a href="/view/data/index.php?action=cs">
                    <div class="hex">
                        <p class="overlayText">Customer Service</p>
                    </div>
                </a>
                <a href="/view/data/index.php?action=misc">
                    <div class="hex">
