    ...
    <div class="mainContainerChildHexContainer">
        <div class="mainContainerChildHexChild">
            ...
            <div class="hex-row hex-row-even">
                <a href="/view/tools/index.php?action=eft">
                    <div class="hex">
                        <p class="overlayText">Amazon EFT Automator</p>
                    </div>
                </a>
                <a href="/view/tools/index.php?action=doug">
                    <div class="hex">
                        <p class="overlayText">Doug Project</p>
                    </div>
                </a>
            </div>
            <div class="hex-row">
