...
<main id="mainContainer">
    ...
    <div class="mainContainerChildbanner">
        <h3>Tools > Accounting > Amazon EFT Automator</h3>
        <a href='/'><img id='settingsIcon' src='/images/settingsIcon.png'></a>
    ...
    <div class="wrapper">
        <div class="header">
            ...
            <a href="/view/tools/index.php?action=exportEftData" class="export">Export QuickBooks File</a>
            <a href="/view/tools/index.php?action=deleteEftData" class="delete">Delete Existing Data</a>
...
<!--     The popup for upload a csv file-->
    <div id="popup_upload">
        <div class="form_upload">
            ...
            <form action="/view/tools/index.php?action=importEftData" method="post" enctype="multipart/form-data">
